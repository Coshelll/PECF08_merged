...
CASES_DATA = {
    ...
    'short_description': 'Умный чат-бот на основе RAG и FAISS',
    'description': '''
    <p>Разработан AI-ассистент для автоматизации поддержки клиентов. Система использует технологию RAG (Retrieval-Augmented Generation) для поиска релевантных ответов в базе знаний компании и генерации точных ответов на вопросы клиентов.</p>
    
    <h4>Основные возможности:</h4>
    <ul>
        <li>Понимание естественного языка через OpenAI GPT</li>
        <li>Контекстные ответы на основе найденных документов</li>
        <li>Интеграция с базой знаний (FAQ и текстовые документы)</li>
        <li>Векторный поиск через FAISS для быстрого нахождения ответов</li>
        <li>Готовый чат-виджет для встраивания на сайт</li>
        <li>Автоматическое обновление базы знаний</li>
    </ul>
    
    <h4>Технологии:</h4>
    <p>Python, Flask, FAISS, OpenAI API, sentence-transformers, HTML/CSS/JS, FastAPI</p>
    
    <h4>Результат:</h4>
    <p>Автоматизация ответов на частые вопросы клиентов, сокращение времени ответа поддержки на 90%, круглосуточная доступность ассистента, обработка 80% запросов без участия операторов.</p>
    
    <h4>Попробовать:</h4>
    <p>Нажмите на кнопку чата в правом нижнем углу экрана и задайте любой вопрос о компании, услугах или сроках выполнения заказов!</p>
    ''',
